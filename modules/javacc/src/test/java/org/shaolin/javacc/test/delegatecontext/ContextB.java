...
public class ContextB implements ParsingContext, EvaluationContext
{
        ...
        if ("setValue".equals(name))
        {
            if (argClasses.size() == 1)
            {
                ...
                if (argClass == String.class)
                {
                    try
                    {
                        foundMethod = ContextB.class.getMethod("setVarBValue",
            ...
            throws EvaluationException
    {
        ...
        else
        {
            ...
            setVarBValue(argValue);
        }

        return null;
    }

    public void setVarBValue(String value)
    {
        variableB = value;
    }
