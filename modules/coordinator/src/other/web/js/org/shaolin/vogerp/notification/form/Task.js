...
function org_shaolin_vogerp_notification_form_Task(json)
{
    ...
    {
        /* Construct_FIRST:org_shaolin_vogerp_notification_form_Task */
        /* Construct_LAST:org_shaolin_vogerp_notification_form_Task */
    };

    Form.Save = org_shaolin_vogerp_notification_form_Task_Save;

    Form.Cancel = org_shaolin_vogerp_notification_form_Task_Cancel;

    Form.__entityName="org.shaolin.vogerp.notification.form.Task";
...
/* Other_Func_FIRST:org_shaolin_vogerp_notification_form_Task */
/* Other_Func_LAST:org_shaolin_vogerp_notification_form_Task */

    /* auto generated eventlistener function declaration */
    function org_shaolin_vogerp_notification_form_Task_Save(eventsource,event) {/* Gen_First:org_shaolin_vogerp_notification_form_Task_Save */

        // cal ajax function. 

        UIMaster.triggerServerEvent(UIMaster.getUIID(eventsource),"saveDetail37238048",UIMaster.getValue(eventsource),this.__entityName);

        var UIEntity = this;
    }/* Gen_Last:org_shaolin_vogerp_notification_form_Task_Save */


    /* auto generated eventlistener function declaration */
    function org_shaolin_vogerp_notification_form_Task_Cancel(eventsource,event) {/* Gen_First:org_shaolin_vogerp_notification_form_Task_Cancel */

        // cal ajax function. 

        UIMaster.triggerServerEvent(UIMaster.getUIID(eventsource),"cancelDetail988697290",UIMaster.getValue(eventsource),this.__entityName);

        var UIEntity = this;
    }/* Gen_Last:org_shaolin_vogerp_notification_form_Task_Cancel */
