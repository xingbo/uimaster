 ...
 * 				by
 * 				all the real types. It contains some basic attributes
 * 				like timeout
 * 				etc.When IEvent passed to one node, ac will
 * 				call the node's process()
 * 				method. process and timeout
 * 				are handler beans which handle normal or
 * 				abnormal event.
 * 			
 * 
