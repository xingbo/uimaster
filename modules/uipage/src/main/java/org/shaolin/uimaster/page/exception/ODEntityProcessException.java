 ...
 * @author Shaolin Wu
 */
public class ODEntityProcessException extends ODProcessException
{
    /**
     ...
     * @param aReason
     */
    public ODEntityProcessException(String aReason)
    {
        super(aReason);
    }
     ...
     * @param args
     */
    public ODEntityProcessException(String aReason, Object[] args)
    {
        super(aReason, args);
    }
     ...
     * @param aThrowable
     */
    public ODEntityProcessException(String aReason, Throwable aThrowable)
    {
