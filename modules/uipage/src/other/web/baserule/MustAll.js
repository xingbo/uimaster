...
function bmiasia_ebos_constraint_baserule_MustAll()
{
	...
	for(var i = 0; i < this.ui.validationList.length; i++)
	{
		...
		if (this.ui.validationList[i][1] == bmiasia_ebos_constraint_baserule_MustAll_internal 
	...
	if(!isExisted)
	{
		...
		this.ui.validationList.push(new Array(action, bmiasia_ebos_constraint_baserule_MustAll_internal));
	}
		
	registerConstraint(this.ui);
	return bmiasia_ebos_constraint_baserule_MustAll_internal.call(this);
}

function bmiasia_ebos_constraint_baserule_MustAll_internal() {
