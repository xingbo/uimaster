...
public class EntityNotFoundException extends BaseRuntimeException {
     ...
     */
    public EntityNotFoundException(String aReason)
    {
     ...
     */
    public EntityNotFoundException(Throwable aThrowable)
    {
     ...
     */
    public EntityNotFoundException(String aReason, Object[] args)
    {
     ...
     * @param   aThrowable      the nested throwable
     */
    public EntityNotFoundException(String aReason, Throwable aThrowable)
    {
